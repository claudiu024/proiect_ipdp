...
export default function Soup(){
    ...
    <div>
       ...
       <ProductContainer>
    <Product product_name="Chicken Noodles Soup" image={ChickenNoodlesSoup} price={4}></Product>
            <Product product_name="Pea And Mint Soup " image={PeaAndMintSoup} price={4}></Product>
            <Product product_name="Creamy Carrot Soup" image={CreamyCarrotSoup}  price={4}></Product>
            <Product product_name="Tom Yum" image={TomYum} price={4}></Product>
    </ProductContainer>
   
       
        <ProductContainer>
            <Product product_name="Three Bean Soup" image={ThreeBeanSoup} price={4}></Product>
            <Product product_name="Caulyflower Soup" image={CaulyflowerSoup} price={4}></Product>
            <Product product_name="Ramen Soup" image={RamenSoup}  price={4}></Product>
            <Product product_name="Hot And Sour Fish Soup" image={HotAndSourFishSoup} price={4}></Product>
        </ProductContainer>
        
        <ProductContainer data_aos="fade-up">
            <Product product_name="Sweet Potato Soup" image={SweetPotatoSoup} price={4}></Product>
            <Product product_name="Fish Soup" image={FishSoup} price={4}></Product>
            <Product product_name="Butter Bean Soup" image={ButterBeanSoup}  price={4}></Product>
            <Product product_name="Verdant Soup" image={VerdantSoup} price={4}></Product>
        </ProductContainer>
            </div>
